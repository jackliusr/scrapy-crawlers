...
class AllSchoolSpider(BaseSpider):
    name = "allSchool"
    allowed_domains = ["moe.edu.sg"]    
 
    def start_requests(self):     
      prim_school_codes = ['1150', '1234', '1249', '1230', '1196', '1129', '1145',
      ...
      sec_school_codes =['3072', '3201', '3001', '3026', '3501', '3002', '3003', '3069', '3033', '3027', '3229', 
      ...
      jc_school_codes = ['0803', '0802', '0805', '0804', '0705', '0713', 
	  '0703', '0712', '0711', '0710', '0709', '0708']
      
      school_codes = prim_school_codes + sec_school_codes + jc_school_codes
      for code in school_codes:
	kind = ""
	if code in prim_school_codes: 
	  kind = "Primary"
	if code in sec_school_codes:
	  kind = "Secondary"
	if code in jc_school_codes:
	  kind = "Junior College"
	request = Request(url='http://sis.moe.gov.sg/SchoolDetails.aspx?schoolCode={0}'.format(code),callback= self.parse_school)
	request.meta["schoolType"] = kind
	yield request
